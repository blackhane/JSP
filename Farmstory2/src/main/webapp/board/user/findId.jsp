	...
	$(function(){
		...
		$('.btnNext').click(function(){
			...
			if(isEmailOk && isEmailAuthOk){
				$.ajax({
					url : '/Farmstory2/board/user/findId.do',
					method : 'post',
					data : jsonData,
					dataType : 'json',
					success : function(data){
						...
						if(result > 0){
							location.href = "/Farmstory2/board/user/findIdResult.do";
							return true;
						}else{
        ...
        <main id="user">
            <section class="find findId">
                ...
                <div>
                    ...
                    <a href="/Farmstory2/board/user/findIdResult.do" class="btn btnNext">다음</a>
                </div>
            </section>
        </main>
